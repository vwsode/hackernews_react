                ...
                <div className={s.wrapper}>
                    ...
                    <nav className={s.nav}>
                        <ul className={s.nav__list}>
                            {navigation.map((item) => (
                                <li key={crypto.randomUUID()} className={s.nav__item}>
                                    <NavLink className={s.nav__link} to={item.path}>
                                        {item.text}
                                    </NavLink>
                                </li>
                            ))}
